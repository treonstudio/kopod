...
import type { ActionAccept, ActionClient } from 'astro/dist/actions/runtime/virtual/server.js';
import type { RoutingStrategies } from 'astro/dist/i18n/utils.js';
import type { ComponentInstance, SerializedRouteData } from 'astro/dist/types/astro.js';
import type { AstroMiddlewareInstance } from 'astro/dist/types/public/common.js';
import type { AstroConfig, Locales, ResolvedSessionConfig } from 'astro/dist/types/public/config.js';
import type { RouteData, SSRComponentMetadata, SSRLoadedRenderer, SSRResult } from 'astro/dist/types/public/internal.js';
