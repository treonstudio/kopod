import { z } from 'zod';
import type { APIContext } from 'astro/dist/types/public/index.js';
import { type ActionAPIContext, type ErrorInferenceObject, type MaybePromise } from 'astro/dist/actions/runtime/utils.js';
import { type SafeResult, type SerializedActionResult, deserializeActionResult, serializeActionResult } from 'astro/dist/actions/runtime/virtual/shared.js';
