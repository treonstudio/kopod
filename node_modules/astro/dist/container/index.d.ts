import 'astro/dist/container/polyfill.js';
import type { AstroComponentFactory } from 'astro/dist/runtime/server/index.js';
import type { Props } from 'astro/dist/types/public/common.js';
import type { AstroUserConfig } from 'astro/dist/types/public/config.js';
import type { NamedSSRLoadedRendererValue, RouteType, SSRLoadedRenderer, SSRLoadedRendererValue, SSRManifest, SSRResult } from 'astro/dist/types/public/internal.js';
