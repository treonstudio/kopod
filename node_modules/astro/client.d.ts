...
declare module 'astro:assets' {
	...
	type AstroAssets = {
		 ...
		 */
		getImage: (
			options: import('astro/dist/assets/types.js').UnresolvedImageTransform,
		) => Promise<import('astro/dist/assets/types.js').GetImageResult>;
		imageConfig: import('astro/dist/types/public/config.js').AstroConfig['image'] & {
			experimentalResponsiveImages: boolean;
		};
		getConfiguredImageService: typeof import('astro/dist/assets/index.js').getConfiguredImageService;
		inferRemoteSize: typeof import('astro/dist/assets/utils/index.js').inferRemoteSize;
		Image: typeof import('astro/components/Image.astro').default;
		Picture: typeof import('astro/components/Picture.astro').default;
		Font: typeof import('astro/components/Font.astro').default;
	};

	type ImgAttributes = import('astro/dist/type-utils.js').WithRequired<
		Omit<import('astro/types.js').HTMLAttributes<'img'>, 'src' | 'width' | 'height'>,
		'alt'
	>;

	export type LocalImageProps = import('astro/dist/type-utils.js').Simplify<
		import('astro/dist/assets/types.js').LocalImageProps<ImgAttributes>
	>;
	export type RemoteImageProps = import('astro/dist/type-utils.js').Simplify<
...
type ImageMetadata = import('astro/dist/assets/types.js').ImageMetadata;
...
declare module 'astro:transitions' {
	type TransitionModule = typeof import('astro/dist/virtual-modules/transitions.js');
	export const slide: TransitionModule['slide'];
	export const fade: TransitionModule['fade'];
	export const createAnimationScope: TransitionModule['createAnimationScope'];

	type ClientRouterModule = typeof import('astro/components/ClientRouter.astro');
	/**
...
declare module 'astro:transitions/client' {
	type TransitionRouterModule = typeof import('astro/dist/virtual-modules/transitions-router.js');
	...
	export type Fallback = import('astro/dist/virtual-modules/transitions-types.js').Fallback;
	export type Direction = import('astro/dist/virtual-modules/transitions-types.js').Direction;
	// biome-ignore format: bug
	export type NavigationTypeString = import('astro/dist/virtual-modules/transitions-types.js').NavigationTypeString;
	export type Options = import('astro/dist/virtual-modules/transitions-types.js').Options;

	type EventModule = typeof import('astro/dist/virtual-modules/transitions-events.js');
	...
	// biome-ignore format: bug
	export type TransitionBeforePreparationEvent = import('astro/dist/virtual-modules/transitions-events.js').TransitionBeforePreparationEvent;
	// biome-ignore format: bug
	export type TransitionBeforeSwapEvent = import('astro/dist/virtual-modules/transitions-events.js').TransitionBeforeSwapEvent;
	...
	// biome-ignore format: bug
	type TransitionSwapFunctionModule = typeof import('astro/dist/virtual-modules/transitions-swap-functions.js');
...
declare module 'astro:config/server' {
	// biome-ignore format: bug
	type ServerConfigSerialized = import('astro/dist/types/public/manifest.js').ServerDeserializedManifest;
...
declare module 'astro:config/client' {
	// biome-ignore format: bug
	type ClientConfigSerialized = import('astro/dist/types/public/manifest.js').ClientDeserializedManifest;
	const manifest: ClientConfigSerialized;
	export = manifest;
}

declare module 'astro:components' {
	export * from 'astro/components/index.js';
}

declare module 'astro:schema' {
	export * from 'astro/zod.js';
}

type MD = import('astro/dist/types/public/content.js').MarkdownInstance<Record<string, any>>;
...
declare module '*.mdx' {
	type MDX = import('astro/dist/types/public/content.js').MDXInstance<Record<string, any>>;
...
declare module 'astro:ssr-manifest' {
	export const manifest: import('astro/dist/types/public/internal.js').SSRManifest;
}
